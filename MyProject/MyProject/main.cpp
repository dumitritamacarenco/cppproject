...
void main() {
	...
	//Event event1;
	//int data[]{ 12, 23,33 };
	//Event event2(1," Country tour Carla's ", 60, " December 23, 18:00", data, 3 , EventType::Another, true);
	//cout << endl << event2;
	...
	//if (event3 > event4)
	//{
	//	cout << "Price at the entrance for the event 3 are more expensive than event 3 ";
	//}
